...
public class ClientCommandUtil {
	...
	public static void init(){
		...
		packagers.put(ClientCommandPackager4Report.name, new ClientCommandPackager4Report());
		packagers.put(ClientCommandPackager4FileTransfer.name, new ClientCommandPackager4FileTransfer());
		initialed=true;
	}
