...
public class RemotePackageIQ extends IQ {
    ...
    static private final String[] CMD_STR_ARRAYS = { "update", "enable",
            "disable", "uninstall", "install" };
    ...
    /*
     * <remotepackage xmlns="com.zm.epad.xmpp"> <cmdtype>install</cmdtype>
     * <cmdargs>com.android.email;com.android.browser</cmdargs>
     * <result>false;true<result> //only for result packet </remotepackage>
     */
    @Override
