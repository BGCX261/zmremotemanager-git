...
public class RemoteDeviceAdmin extends PreferenceActivity {
    ...
    private static final String TAG = "RemoteDeviceAdmin";
    ...
    ComponentName mRemoteDeviceAdmin;
    ...
    private boolean isActiveAdmin() {
        return mDPM.isAdminActive(mRemoteDeviceAdmin);
    }
    ...
    public static class RemoteAdminFragment extends PreferenceFragment
        ...
        protected ComponentName mRemoteDeviceAdminFragment;
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            mActivity = (RemoteDeviceAdmin) getActivity();
            mDPM = mActivity.mDPM;
            mRemoteDeviceAdminFragment = mActivity.mRemoteDeviceAdmin;
    ...
    public static class GeneralFragment extends RemoteAdminFragment
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mEnableCheckbox) {
                ...
                mDPM.setCameraDisabled(mRemoteDeviceAdminFragment, value);
                reloadSummaries();
    ...
    public static class QualityFragment extends RemoteAdminFragment
        ...
        protected void reloadSummaries() {
            ...
            local = mDPM.getPasswordMinimumLetters(mRemoteDeviceAdminFragment);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mPasswordQuality) {
                mDPM.setPasswordQuality(mRemoteDeviceAdminFragment, value);
     ...
     */
    public static class ExpirationFragment extends RemoteAdminFragment
            implements OnPreferenceChangeListener, OnPreferenceClickListener {
        ...
        protected void reloadSummaries() {
            ...
            int local, global;
            local = mDPM.getPasswordHistoryLength(mRemoteDeviceAdminFragment);
     ...
     */
    public static class EncryptionFragment extends RemoteAdminFragment
            implements OnPreferenceChangeListener, OnPreferenceClickListener {
        ...
        protected void reloadSummaries() {
            ...
            local = mDPM.getStorageEncryption(mRemoteDeviceAdminFragment);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mRequireEncryption) {
                ...
                mDPM.setStorageEncryption(mRemoteDeviceAdminFragment, newActive);
                reloadSummaries();
                return true;
            }
            return true;
